...
public class DragonDeGlace : Monstre
{
        ...
        : base(nom, pointsDeVie, nbDesAttaque, experience)
    {
        ...
        Console.WriteLine($"\n❄️ Le Dragon de Glace {Nom} surgit des montagnes gelées ! Préparez-vous au froid glacial ! ❄️\n");
        Console.ResetColor();
    }
    ...
    private int AttaqueUltime()
    {
        ...
        Console.WriteLine($"\n🌨️ Dragon de Glace {Nom} déclenche son ATTAQUE ULTIME : 'Tempête de Glace' ! 🌨️");
        Console.ResetColor();
        Thread.Sleep(1000);
        Console.WriteLine("❄️ Un blizzard furieux enveloppe le champ de bataille !");
        Thread.Sleep(1000);
